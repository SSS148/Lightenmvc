...
namespace Lighten.Controllers
{
        public class ProductsController : Controller
        {
            ...
            public ProductsController(LightenContext context)
            {
                _context = context;
            }
        ...
        public IActionResult Create()
            ...
            public async Task<IActionResult> Create([Bind("Id,LightModel,LightCompany,LightType,Price")] Products Products)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public async Task<IActionResult> Edit(int id, [Bind("Id,LightModel,LightCompany,LightType,Price")] Products Products)
            {
                if (id != Products.Id)
                {
                    return NotFound();
